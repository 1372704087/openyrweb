...
const EN_LOCALE = {
  ...
  "STT:SinglePlayer": "Play single-player campaign and skirmish games",
  "GUI:Campaign": "Campaign",
  "STT:Campaign": "Play the single-player campaign",
  "GUI:CampaignMissionList": "Mission List",
  "GUI:CampaignSelector": "Back to Campaign Selection",
  "GUI:CampaignResourceTitle": "Campaign Resources",
  "GUI:CampaignResourceChecking": "Checking campaign resources...",
  "GUI:CampaignResourcePrompt": "Campaign maps were not found. Import the campaign Mix files (maps01.mix / maps02.mix / mapsmd03.mix) through Storage first.",
  "GUI:CampaignResourceInstall": "Import Campaign Mix",
  "GUI:CampaignResourceError": "Failed to load campaign resources.",
  "GUI:CampaignResourceRetry": "Retry",
  "GUI:AlliedCampaign": "Allied Campaign",
  "GUI:SovietCampaign": "Soviet Campaign",
  "GUI:TutorialCampaign": "Tutorial",
  "GUI:Difficulty": "Difficulty",
  "GUI:SkirmishGame": "Skirmish",
  "GUI:ImportMixFiles": "Import Mix Files",
  "TS:MixFilesImported": "Imported %d mix file(s). Restart the game for the changes to take effect.",
  "TS:ImportMixFailed": "Failed to import mix files.",
...
const ZH_CN_LOCALE = {
  ...
  "GUI:SinglePlayer": "单机模式",
  "STT:SinglePlayer": "进行单人战役与遭遇战",
  "GUI:Campaign": "战役",
  "STT:Campaign": "进行单人战役",
  "GUI:CampaignMissionList": "全部关卡",
  "GUI:CampaignSelector": "返回战役选择",
  "GUI:CampaignResourceTitle": "战役资源",
  "GUI:CampaignResourceChecking": "正在检查战役资源...",
  "GUI:CampaignResourcePrompt": "未检测到战役地图。请先通过「存储」导入包含战役地图的 Mix 文件（maps01.mix / maps02.mix / mapsmd03.mix）。",
  "GUI:CampaignResourceInstall": "导入战役 Mix",
  "GUI:CampaignResourceError": "战役资源加载失败。",
  "GUI:CampaignResourceRetry": "重试",
  "GUI:AlliedCampaign": "盟军战役",
  "GUI:SovietCampaign": "苏军战役",
  "GUI:TutorialCampaign": "新兵训练营",
  "GUI:Difficulty": "难度",
  "GUI:SkirmishGame": "遭遇战",
  "GUI:ImportMixFiles": "导入 Mix 文件",
  "TS:MixFilesImported": "已导入 %d 个 Mix 文件。重新启动游戏后生效。",
  "TS:ImportMixFailed": "导入 Mix 文件失败。",
...
const ZH_TW_LOCALE = {
  ...
  "GUI:SinglePlayer": "單機模式",
  "STT:SinglePlayer": "進行單人戰役與遭遇戰",
  "GUI:Campaign": "戰役",
  "STT:Campaign": "進行單人戰役",
  "GUI:CampaignMissionList": "全部關卡",
  "GUI:CampaignSelector": "返回戰役選擇",
  "GUI:CampaignResourceTitle": "戰役資源",
  "GUI:CampaignResourceChecking": "正在檢查戰役資源...",
  "GUI:CampaignResourcePrompt": "未偵測到戰役地圖。請先透過「儲存」匯入包含戰役地圖的 Mix 檔案（maps01.mix / maps02.mix / mapsmd03.mix）。",
  "GUI:CampaignResourceInstall": "匯入戰役 Mix",
  "GUI:CampaignResourceError": "戰役資源載入失敗。",
  "GUI:CampaignResourceRetry": "重試",
  "GUI:AlliedCampaign": "盟軍戰役",
  "GUI:SovietCampaign": "蘇軍戰役",
  "GUI:TutorialCampaign": "新兵訓練營",
  "GUI:Difficulty": "難度",
  "GUI:SkirmishGame": "遭遇戰",
  "GUI:ImportMixFiles": "匯入 Mix 檔案",
  "TS:MixFilesImported": "已匯入 %d 個 Mix 檔案。重新啟動遊戲後生效。",
  "TS:ImportMixFailed": "匯入 Mix 檔案失敗。",
