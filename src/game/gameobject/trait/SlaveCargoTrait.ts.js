...
//
// Lightweight cargo trait for SlaveMiner slaves (SLAV infantry). The full
...
//
// (2026-06-30, REVERSED): a `status` field was added so the harvest ANIMATION
...
// , HarvesterPlugin watches `harvesterTrait.status === HarvesterStatus.Harvesting`
        ...
        (class {
          ...
          constructor(e) {
            ((this.storage = e),
              ...
              (this._gems = 0),
              (this.bails = new Map()),
              // harvest-anim driver. Mirrors HarvesterStatus (Idle=0, Harvesting=3).
