            ...
            (i = class {
              static tickStationary(s, a) {
                if (s.zone === M.ZoneType.Air) {
                  ...
                  // keep the attitude consistent while stationary — the nose
              ...
              tick(t, e, i, r) {
                ...
                // bank into turns (vanilla YR behaviour). The target bank angle
                ...
                // wing sway (vanilla sub_4CF830) — a gentle roll oscillation
                ...
                let f = !1,
                  ...
                  T = 0;
                let v = !0;
                // no dive — the plane keeps its cruise altitude through
                ...
                // nose pitch from vertical speed (vanilla YR behaviour) — climb
