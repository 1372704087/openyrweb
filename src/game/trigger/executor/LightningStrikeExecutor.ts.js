// === Reconstructed SystemJS module: game/trigger/executor/LightningStrikeExecutor ===
          ...
          execute(e) {
            ...
            s
              ? !(t = e.getAllPlayers().find((e) => !e.defeated && e.country?.name === this.trigger.houseName)) ||
                ((i = [...e.rules.superWeaponRules.values()].find(
                  (e) => e.type === n.SuperWeaponType.LightningStorm,
                )) &&
