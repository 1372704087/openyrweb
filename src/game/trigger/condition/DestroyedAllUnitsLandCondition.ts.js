// === Reconstructed SystemJS module: game/trigger/condition/DestroyedAllUnitsLandCondition ===
    ...
    return {
      ...
      execute: function () {
        ((a = class extends s.TriggerCondition {
          ...
          check(e, t) {
            return (
              ...
              (!!t.some((e) => {
                ...
                let t = e.target;
                return !(!t.isUnit() || t.owner.country?.id !== this.houseId) && !this.hasLandUnitsLeft(t.owner);
              }) &&
                (this.allDestroyed = !0))
            );
          }
          ...
          e("DestroyedAllUnitsLandCondition", a));
      },
    };
  },
);
