// === Reconstructed SystemJS module: game/trigger/condition/DestroyedBuildingsCondition ===
          ...
          check(e, t) {
            ...
            for (var i of t)
              if (i.type === r.EventType.ObjectDestroy) {
                let e = i.target;
                e.isBuilding() && e.owner.country?.id === this.houseId && this.count++;
              }
            return this.count >= this.threshold;
          }
        }),
          e("DestroyedBuildingsCondition", s));
      },
    };
  },
);
