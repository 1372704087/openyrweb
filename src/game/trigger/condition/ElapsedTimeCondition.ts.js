// === Reconstructed SystemJS module: game/trigger/condition/ElapsedTimeCondition ===
      ...
      execute: function () {
        ((s = class extends r.TriggerCondition {
          constructor(e, t) {
            (super(e, t),
              (this.elapsedTicks = 0),
              (this.timerTicks = Number(this.event.params[1]) * i.GameSpeed.BASE_TICKS_PER_SECOND));
          }
          check(e) {
