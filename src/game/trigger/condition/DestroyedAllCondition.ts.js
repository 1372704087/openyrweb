// === Reconstructed SystemJS module: game/trigger/condition/DestroyedAllCondition ===
          ...
          check(e, t) {
            return (
              ...
              (!!t.some((e) => {
                ...
                let t = e.target;
                return !(!t.isTechno() || t.owner.country?.id !== this.houseId) && !t.owner.getOwnedObjects(!0).length;
              }) &&
                (this.allDestroyed = !0))
            );
          }
        }),
          e("DestroyedAllCondition", s));
      },
    };
  },
);
