...
/**
 * paletteShaderLib — 调色板材质的 GLSL 着色器片段库。
 *
 * 包含 VPL 体素查表光照、调色板采样、实例化属性、额外光照、顶点多重
 * 颜色等待填充片段。vplTexture/vplEnabled 由 GameRes.loadVpl 填充。
 * extraLight 死区：正常 0.2 不动、瘫痪 -0.35 压暗、无敌提亮。
 *
 * 由 engine/gfx/material/paletteShaderLib.ts.js 机械重写为 TS（对象
 * 字面量原样提取，行为完全一致）。两个文件并存期间，本文件才是修改
 * 目标：tools/repack.mjs 打包时优先采用 .ts 模块的编译产物。
 */

/* eslint-disable @typescript-eslint/no-explicit-any */
export const paletteShaderLib: any = {
