                  ...
                  return (
                    (async () => {
                      ...
                      try {
                        ...
                        // Build file-explorer langmap based on browser language
                        var lang = typeof navigator !== "undefined" && navigator.language || "";
                        var langmap = /^zh/i.test(lang) ? {
                          ...
                          "Ctrl + V\u00A0\u00A0\u00A0/\u00A0\u00A0\u00A0Right-click + Paste": "Ctrl + V\u00A0\u00A0\u00A0/\u00A0\u00A0\u00A0右键 + 粘贴",
                          ...
                          "Paste operation failed due to mismatched group name": "粘贴失败：组名不匹配",
                          "{0} uploading": "{0} 正在上传",
                          "{2} done": "{2} 已完成",
                          "{3} failed": "{3} 失败",
                          "{0}/s": "{0}/秒",
