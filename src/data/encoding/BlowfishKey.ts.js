// === Reconstructed SystemJS module: data/encoding/BlowfishKey ===
// deps: []
// Note: variable/type names are minified approximations of the original TypeScript.

System.register("data/encoding/BlowfishKey", [], function (e, t) {
  "use strict";
  var s, a, i, r;
  t && t.id;
  return {
    setters: [],
    execute: function () {
      ((s = "AihRvNoIbTn85FZRYNZRcT+i6KpU+maCsEqr3Q5q+LDB5tH7Tz2qQ38V"),
        (a = new Int8Array([
        ...
        (i = class {
          constructor() {
            ((this.key1 = new Uint32Array(64)), (this.key2 = new Uint32Array(64)));
          }
        }),
        e(
          "BlowfishKey",
          (r = class {
            ...
            key_to_bignum(e, t, i) {
              ...
              if (2 === t[a]) {
                if ((a++, 0 != (128 & t[a]))) {
                  for (r = 0, s = 0; s < (127 & t[a]); s++) r = (((r << 8) >>> 0) | t[a + s + 1]) >>> 0;
                  a += 1 + (127 & t[a]);
                } else ((r = t[a]), a++);
            ...
            bitlen_bignum(e, t) {
              ...
              for (r = 32 * i, s = 2147483648; 0 == (s & e[i - 1]);) ((s >>>= 1), r--);
              return r;
            }
            init_pubkey() {
              let e = 0,
              ...
              for (this.init_bignum(this.pubkey.key2, 65537, 64), t = 0; e < s.length;)
                ((i =
                  ((((((((((((a[s.charCodeAt(e++)] >>> 0) << 6) >>> 0) | (255 & a[s.charCodeAt(e++)])) >>> 0) << 6) >>>
                    0) |
            ...
            shr_bignum(e, t, i) {
              ...
              if (0 !== t) {
                for (r = 0; r < i - 1; r++) e[r] = ((e[r] >>> t) | ((e[r + 1] << (32 - t)) >>> 0)) >>> 0;
                e[r] = e[r] >>> t;
              }
            }
            shl_bignum(e, t, i) {
              ...
              if (0 !== t) {
                for (r = i - 1; 0 < r; r--) e[r] = (((e[r] << t) >>> 0) | (e[r - 1] >>> (32 - t))) >>> 0;
                e[0] = (e[0] << t) >>> 0;
              }
            }
            sub_bignum(e, t, i, r, s) {
              ...
              let h = 0;
              for (; -1 != --s;)
                ((a = o[h]), (n = l[h]), (c[h] = (a - n - r) & 65535), (r = 0 != ((a - n - r) & 65536) ? 1 : 0), h++);
              return r;
            }
            sub_bignum_word(e, t, i, r, s) {
              ...
              let o = 0;
              for (; -1 != --s;)
                ((a = t[o]), (n = i[o]), (e[o] = (a - n - r) & 65535), (r = 0 != ((a - n - r) & 65536) ? 1 : 0), o++);
              return r;
            }
            inv_bignum(e, t, i) {
              ...
              for (
                this.init_bignum(r, 0, i),
                  ...
                  o = (((n + 32) / 32) | 0) - 1,
                  s = (4 * (((n - 1) / 32) | 0)) >>> 0,
                  r[(s / 4) | 0] = r[(s / 4) | 0] | ((1 << ((n - 1) & 31)) >>> 0);
                0 < n;
              )
                (n--,
                  this.shl_bignum(r, 1, i),
                  -1 !== this.cmp_bignum(r, t, i) && (this.sub_bignum(r, r, t, 0, i), (e[o] = e[o] | (a >>> 0))),
                  (a >>>= 1),
                  0 === a && (o--, (a = 2147483648)));
              this.init_bignum(r, 0, i);
            }
            ...
            init_two_dw(e, t) {
              (this.mov_bignum(this.glob1, e, t),
                ...
                32 < this.bitlen_bignum(this.glob1_hi_inv, 2) &&
                  (this.shr_bignum(this.glob1_hi_inv, 1, 2), this.glob1_hi_bitlen--),
            ...
            mul_bignum_word(e, t, i, r) {
              ...
              let o = (a = 0);
              for (s = 0; s < r; s++) ((a = i * n[o] + e[o] + a), (e[o] = 65535 & a), o++, (a >>>= 16));
              e[o] += 65535 & a;
            }
            mul_bignum(e, t, i, r) {
              let s;
              ...
              let o = 0;
              for (s = 0; s < 2 * r; s++) (this.mul_bignum_word(n.subarray(o), t, a[o], 2 * r), o++);
            }
            not_bignum(e, t) {
              let i;
            ...
            calc_a_bignum(e, t, i, r) {
              ...
              if (
                ...
                (this.glob2[2 * r] = 0),
                (s = 2 * this.len_bignum(this.glob2, 2 * r + 1)) >= this.glob1_len_x2)
              ) {
                ...
                for (; 0 !== a; a--) {
                  ...
                  0 < l &&
                    ...
                    0 == (32768 & e[i]) &&
                      0 !== this.sub_bignum_word(c, c, new Uint16Array(n.buffer), 0, 2 * r) &&
                      e[i]--);
                }
                (this.neg_bignum(this.glob2, r), this.dec_bignum(this.glob2, r));
              }
            ...
            calc_a_key(e, t, i, r, s) {
              ...
              for (
                ...
                (0 === c && ((c = 2147483648), h--),
                  ...
                  0 != (i[h] & c) ? this.calc_a_bignum(e, o, t, n) : this.mov_bignum(e, o, n),
                  (c >>>= 1));
            ...
            decryptKey(e) {
              ...
              return (this.process_predata(e, this.len_predata(), t), t.subarray(0, 56));
            }
          }),
        ));
    },
