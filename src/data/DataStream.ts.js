// === Reconstructed SystemJS module: data/DataStream ===
// deps: []
// Note: variable/type names are minified approximations of the original TypeScript.

System.register("data/DataStream", [], function (e, t) {
  "use strict";
  var n;
  t && t.id;
  return {
    ...
    execute: function () {
      (e(
        "DataStream",
        (n = class n {
          constructor(e, t, i = n.LITTLE_ENDIAN) {
            ((this.endianness = i),
              (this.position = 0),
              (this._dynamicSize = !0),
              (this._byteLength = 0),
          ...
          bigEndian() {
            return ((this.endianness = n.BIG_ENDIAN), this);
          }
          _realloc(t) {
          ...
          mapInt32Array(e, t) {
            ...
            return (n.arrayToNative(i, void 0 === t ? this.endianness : t), (this.position += 4 * e), i);
          }
          mapInt16Array(e, t) {
            this._realloc(2 * e);
            var i = new Int16Array(this._buffer, this.byteOffset + this.position, e);
            return (n.arrayToNative(i, void 0 === t ? this.endianness : t), (this.position += 2 * e), i);
          }
          mapInt8Array(e) {
            this._realloc(e);
          ...
          mapFloat64Array(e, t) {
            ...
            return (n.arrayToNative(i, void 0 === t ? this.endianness : t), (this.position += 8 * e), i);
          }
          mapFloat32Array(e, t) {
            this._realloc(4 * e);
          ...
          readInt32Array(e, t) {
            ...
            return (
              n.memcpy(i.buffer, 0, this.buffer, this.byteOffset + this.position, e * i.BYTES_PER_ELEMENT),
              n.arrayToNative(i, void 0 === t ? this.endianness : t),
          ...
          readInt8Array(e) {
            ...
            return (
              n.memcpy(t.buffer, 0, this.buffer, this.byteOffset + this.position, e * t.BYTES_PER_ELEMENT),
          ...
          writeInt32Array(t, i) {
            if (
              ...
              (n.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, t.byteOffset, t.byteLength),
          ...
          writeFloat64Array(t, i) {
            ...
            else for (let e = 0; e < t.length; e++) this.writeFloat64(t[e], i);
            return this;
          }
          writeFloat32Array(t, i) {
            ...
            else for (let e = 0; e < t.length; e++) this.writeFloat32(t[e], i);
            return this;
          }
          readInt32(e) {
          ...
          writeInt8(e) {
            return (this._realloc(1), this._dataView.setInt8(this.position, e), (this.position += 1), this);
          }
          writeUint32(e, t) {
            return (
              this._realloc(4),
          ...
          writeUint8(e) {
            return (this._realloc(1), this._dataView.setUint8(this.position, e), (this.position += 1), this);
          }
          writeFloat32(e, t) {
            return (
              this._realloc(4),
          ...
          readUCS2String(e, t) {
            return n.createStringFromArray(this.readUint16Array(e, t));
          }
          writeUCS2String(e, t, i) {
            void 0 === i && (i = e.length);
            let r = 0;
            for (; r < e.length && r < i; r++) this.writeUint16(e.charCodeAt(r), t);
            for (; r < i; r++) this.writeUint16(0);
            return this;
          }
          readString(e, t) {
            return void 0 === t || "ASCII" === t
              ? n.createStringFromArray(this.mapUint8Array(void 0 === e ? this.byteLength - this.position : e))
          ...
          writeString(t, e, i) {
            if (void 0 === e || "ASCII" === e)
              ...
              } else for (let e = 0; e < t.length; e++) this.writeUint8(t.charCodeAt(e));
            else this.writeUint8Array(new TextEncoder().encode(t.substring(0, i)));
            return this;
          }
          writeUtf8WithLen(e) {
          ...
          readCString(e) {
            ...
            let s = 0;
            for (; s < r && 0 !== i[s]; s++);
            var a = n.createStringFromArray(this.mapUint8Array(s));
            return (void 0 !== e ? (this.position += r - s) : s !== t && (this.position += 1), a);
          }
          writeCString(t, i) {
            if (void 0 !== i) {
              let e;
        ...
        (n.BIG_ENDIAN = !1),
        (n.LITTLE_ENDIAN = !0),
        (n.endianness = 0 < new Int8Array(new Int16Array([1]).buffer)[0]));
    },
  };
});
